...
class VehicleModel(BaseModel):
    ...
    registration_certificate_image = models.FileField(upload_to='vehicle/', null=True)
    tax_token_image = models.FileField(upload_to='vehicle/', null=True)
    insurance_image = models.FileField(upload_to='vehicle/', null=True)
